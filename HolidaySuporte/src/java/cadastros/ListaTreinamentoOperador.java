...
@ViewScoped
@ManagedBean
public class ListaTreinamentoOperador {
    ...
    public ListaTreinamentoOperador() throws Exception {
        this.buscar();
    }


    public void buscar() throws Exception {
        this.treinamentoOnline = (TreinamentoOnline) downCadastro.buscar(treinamentoOnline, 4);
    }
