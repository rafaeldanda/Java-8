...
@ViewScoped
@ManagedBean
public class ListaTreinamentoSuporte {
    ...
    public ListaTreinamentoSuporte() throws Exception {
        this.buscar();
    }


    public void buscar() throws Exception {
        this.treinamentoOnline = (TreinamentoOnline) downCadastro.buscar(treinamentoOnline, 2);
    }
