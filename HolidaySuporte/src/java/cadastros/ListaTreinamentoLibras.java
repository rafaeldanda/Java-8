...
@ViewScoped
@ManagedBean
public class ListaTreinamentoLibras {
    ...
    public ListaTreinamentoLibras() throws Exception {
        this.buscar();
    }


    public void buscar() throws Exception {
        this.treinamentoOnline = (TreinamentoOnline) downCadastro.buscar(treinamentoOnline, 3);
    }
